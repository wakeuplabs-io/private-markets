 ...
 * @notice V3 Interface for PredictionMarketCore contract
 * @dev Supports hybrid architecture (Aztec + Arbitrum) with nullifier-based claims
 */
interface IPredictionMarket {
    event MarketCreated(uint256 indexed marketId, address indexed owner, uint256 totalPool, uint256 expiresAt);
    ...
    function createMarket(uint256 marketId, uint256 totalPool, uint256 expiresAt) external;
