    ...
    const validateForm = (): boolean => {
        ...
        if (formData.closingTime <= now) {
            ...
            newErrors.closingTime =
                "Closing time must be at least 1 minute from now";
        }
            ...
            <div className="p-6">
                <div className="mb-4">
                    ...
                    <p className="text-base text-muted-foreground">
                        Set up a new binary Yes or No prediction market.
                    </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                handleClosingTimeChange(e.target.value)
                            }
                        ...
                        <p className="text-xs text-muted-foreground mt-1">
                            ...
                            {getCurrentTimezone()}). Must be in the future.
                        </p>
                        <p className="text-xs text-muted-foreground">
                            Selected time:{" "}
                            {formData.closingTime.toLocaleString()}
                        </p>
                    </div>
