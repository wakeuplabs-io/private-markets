  ...
  const handleConfirmMarket = async () => {
    ...
    try {
      ...
      const mockCreatedMarket: Market = {
        ...
        options: [{ id: 'yes', name: 'Yes', odds: 1.5 }, { id: 'no', name: 'No', odds: 2.0 }],
        status: 'open',
        createdAt: new Date(),
    ...
    <Layout>
      <div className="container mx-auto px-8 py-8">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-muted-foreground">
              Manage prediction markets and monitor platform activity
            </p>
          </div>
          <Button
        ...
        <AdminMarketGrid
          ...
          onResolveMarket={async (marketId: string, winningOption: 'yes' | 'no') => {
